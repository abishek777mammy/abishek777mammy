...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo mr-auto"><a href="index.phpl"><span class="text-primary">Visudh</span> <span class="text-danger">Ajivam</span></a></h1>
                ...
                <ul>
                    ...
                    <li class="drop-down"><a href="login.php">Login</a>
                        <ul>
                            ...
                            <li><a href="#">Cart</a></li>
                            <li><a href="orders.pho">Orders</a></li>
...
<br>
    ...
    <section id="hero" class="d-flex align-items-center">
        ...
        <div class="row">
          ...
          <form class="form" action="<?php $_SERVER['PHP_SELF'];?>">

        <b><label>Phone:</label></b>
        <input class="form-control" type="text" name="name1" placeholder="+91" required>
        <hr>
        ...
        <input class="btn btn-primary" type="submit" name ="submit" value="Create">
            ...
            <h2>We Provide You High
                ...
                <a href="create.html" class="btn-get-started scrollto">Already have an account</a>
        </div>
    </section><!-- End Hero -->
...
error_reporting(0);
$name = $_GET['name1'];
$user_name = $_GET['user_name1'];
$password = $_GET['password1'];
 if(isset( $_GET['submit'] )) {
#connecting to database
$conn = mysqli_connect( "localhost", "root", "", "Database" ) or die( "conn lost" );
$sql = "INSERT INTO table2(name, user_name, password) VALUES('{$name}','{$user_name}','{$password}')";
